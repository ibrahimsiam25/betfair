          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  fear,
                  style: AppTextStyles.fontBlackW400.copyWith(fontSize: 22.sp),
                ),
                SizedBox(
                  height: 10.h,
                ),
            ...
            child: Row(
              children: [
                Text(
                  "$rate",
                  style: AppTextStyles.fontBlackW700
                      .copyWith(fontSize: 24.sp, color: AppColors.green),
                ),
                SvgPicture.asset(width: 8.w, height: 8.h, Assets.imagesDown)
              ],
            ),
          )
        ],
